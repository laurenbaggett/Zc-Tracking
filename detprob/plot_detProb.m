...
for m = 1:length(dfList)
    ...
    if dfList{m} == 'SOCAL_H_72'
        ...
        numDays = 114; % number of days of deployment effort

    elseif dfList{m} == 'SOCAL_H_73'

        load(['F:\Zc_Analysis\tracking_figures\track_density\',dfList{m},'_detectionProbability_ABSOLUTE'])
        numDays = 152; % number of days of deployment effort

    elseif dfList{m} == 'SOCAL_H_74'
        
        load(['F:\Zc_Analysis\tracking_figures\track_density\',dfList{m},'_detectionProbability_ABSOLUTE'])
        numDays = 127; % number of days of deployment effort

    elseif dfList{m} == 'SOCAL_H_75'

        load(['F:\Zc_Analysis\tracking_figures\track_density\',dfList{m},'_detectionProbability_ABSOLUTE'])
        numDays = 182; % number of days of deployment effort
