...
site = 'N'; % sites = {'A2','CCE1','E','G2','H','M','N','R','S','SN','U'};
...
TLfile1 = 'F:\Tracking\prop\SOCAL_N_68\SOCAL_N_68_NS_40kH_3DTL.mat';
TLfile2 =  'F:\Tracking\prop\SOCAL_N_68\SOCAL_N_68_NW_40kH_3DTL.mat';
disp(['TLFile: ',TLfile1,' ', TLfile2])
load('F:\Tracking\prop\SOCAL_N_68\SOCAL_N_68_4ch_offset_m.mat');
...
save('F:\Zc_Analysis\tracking_figures\track_density\SOCAL_N_68_detectionProbability.mat','allsim','alldet','allprob','xline','yline')
...
figure
% flip because detected with instruments in opposite positions
h = imagesc(flipud(xline),yline,flipud(prb_plot),'AlphaData',0.8)
...
save('F:\Zc_Analysis\tracking_figures\track_density\SOCAL_E_63_detectionProbability.mat','allsim','alldet','allprob','xline','yline')