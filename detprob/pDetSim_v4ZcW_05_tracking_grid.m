...
site = 'W'; % sites = {'A2','CCE1','E','G2','H','M','N','R','S','SN','U'};
...
TLfile1 = 'F:\Tracking\prop\SOCAL_W_05\SOCAL_W_05_WE_Cuviers_40kH_3DTL.mat';
TLfile2 =  'F:\Tracking\prop\SOCAL_W_05\SOCAL_W_05_WS_Cuviers_40kH_3DTL.mat';
disp(['TLFile: ',TLfile1,' ', TLfile2])
load('F:\Tracking\prop\SOCAL_W_05\SOCAL_W_05_4ch_offset2_m.mat');
load('F:\Tracking\prop\SOCAL_W_05\SOCAL_W_05_4ch_absolute_m');
...
save('F:\Zc_Analysis\tracking_figures\track_density\SOCAL_W_05_detectionProbability_ABSOLUTE.mat','allsim','alldet','allprob','xline','yline')
...
% load instruments
load('D:\Tracking\Instrument_Orientation\SOCAL_W_05\SOCAL_W_05_WE\REDO\SOCAL_W_05_WE_harp4chParams');
hydLoc{1} = recLoc;
clear recLoc
load('D:\Tracking\Instrument_Orientation\SOCAL_W_05\SOCAL_W_05_WS\REDO\SOCAL_W_05_WS_harp4chParams');
hydLoc{2} = recLoc;
...
title('SOCAL W 05 Detection Probability')
