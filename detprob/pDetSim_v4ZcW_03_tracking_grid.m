...
TLfile1 = 'F:\Tracking\prop\SOCAL_W_03\SOCAL_W_03_WE_Cuviers_40kH_3DTL.mat';
TLfile2 =  'F:\Tracking\prop\SOCAL_W_03\SOCAL_W_03_WS_Cuviers_40kH_3DTL.mat';
disp(['TLFile: ',TLfile1,' ', TLfile2])
load('F:\Tracking\prop\SOCAL_W_03\SOCAL_W_03_4ch_offset2_m.mat');
load('F:\Tracking\prop\SOCAL_W_03\SOCAL_W_03_4ch_absolute_m');
...
% modified these
a2.rd_all{16} = a2.rd_all{16}(1:141);
a2.sortedTLVec{16} = a2.sortedTLVec{16}(1:141,:);
                ...
                for itParms5 = 1: sizeBotAngle
                    ...
                    for itParms6 = 1: sizerotVertForage
                        ...
                        for itParms7 = 1 : sizeminBeamAmp
                            ...
                            % Function for click
                            [sumsim,sumdet,fprob,xline,yline,xdetall,ydetall] = ...
...
save('F:\Zc_Analysis\tracking_figures\track_density\SOCAL_W_03_detectionProbability.mat','allsim','alldet','allprob','xline','yline')
...
title('SOCAL W 03 Detection Probability')
