...
subplot(2,2,4)
histogram(stdSp,[0:1:14],'facecolor',[0 0.4470 0.7410],'facealpha',.5)
xlabel('Std Speed');

subplot(2,2,3)
histogram(stdSpDesc,[0:1:14],'facecolor',[0.8500 0.3250 0.0980],'facealpha',.5)
xlabel('Std Speed');
...
nexttile % subplot(2,4,1)
histogram(mSpDesc(find(site_desc==1)),[0:1:14],'facecolor',[0 0.4470 0.7410],'facealpha',.5)
ylabel('Initial Descent')
title('W')

nexttile % subplot(2,4,2)
histogram(mSpDesc(find(site_desc==2)),[0:1:14],'facecolor',[0.8500 0.3250 0.0980],'facealpha',.5)
title('H')

nexttile % subplot(2,4,3)
histogram(mSpDesc(find(site_desc==3)),[0:1:14],'facecolor',[0.4940 0.1840 0.5560],'facealpha',.5)
ylim([0 5])
title('E')

nexttile % subplot(2,4,4)
histogram(mSpDesc(find(site_desc==4)),[0:1:14],'facecolor',[0.4660 0.6740 0.1880],'facealpha',.5)
title('N')
% ylim([0 20])

nexttile % subplot(2,4,5)
histogram(mSp(find(site==1)),[0:1:14],'facecolor',[0 0.4470 0.7410],'facealpha',1)
ylabel('At Depth')
xlabel('Median Speed (m/s)');
% ylim([0 120])

nexttile % subplot(2,4,6)
histogram(mSp(find(site==2)),[0:1:14],'facecolor',[0.8500 0.3250 0.0980],'facealpha',1)
xlabel('Median Speed (m/s)');
% ylim([0 120])

nexttile % subplot(2,4,7)
histogram(mSp(find(site==3)),[0:1:14],'facecolor',[0.4940 0.1840 0.5560],'facealpha',1)
xlabel('Median Speed (m/s)');
% ylim([0 120])

nexttile % subplot(2,4,8)
histogram(mSp(find(site==4)),[0:1:14],'facecolor',[0.4660 0.6740 0.1880],'facealpha',1)
xlabel('Median Speed (m/s)');
% ylim([0 120])
