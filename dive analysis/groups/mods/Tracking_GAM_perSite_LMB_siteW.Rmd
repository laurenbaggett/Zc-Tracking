...
# read in data
w = read.csv("F:/Tracking/groups/SOCAL_W_binned_20min_groups_allVars.csv")
...
glmod1 = glm(w$groupSize~w$dayNight+w$jd+w$presBins,family=poisson)
summary(glmod1)
...
For site W, lag is 16. 16*20 = 320 minutes. Rebin and then continute on.

```{r rebinned, echo=TRUE}
# rebin to match the earlier lag value

df = read.csv("F:/Tracking/groups/SOCAL_W_binned_320min_groups_allVars.csv")
...
lm1 = lm(groupSize~jd+presBins+dayNight,data=dfMod)
car::vif(lm1)
#       jd presBins dayNight 
# 1.013827 1.012942 1.000884 
...
fullModel = gam(groupSize~
                  + s(dfMod$jd,bs='cc')
                  + s(dfMod$dayNight,bs='cc') # cyclic spline since -1 and 1 are both sunrise
                  + s(presBins,bs='ts'),
                data=dfMod,family=tw(),method='REML')

selectedCovariates = c("s(jd,bs='cc')", "s(dayNight,bs='cc')","s(presBins,bs='ts')")
...
# [1,] "daynight"      "1 3"    "5009.27253191657"
# [2,] "None excluded" "1 2 3"  "5009.27418517481"
# [3,] "jd"            "2 3"    "5013.7135293072" 
# [4,] "pres"          "1 2"    "5125.18717941285"
...
#      Removed         Idx Vars AIC               
# [1,] "jd,daynight"   "3"      "5013.71314958759"
# [2,] "pres,daynight" "1"      "5125.18336743162"
...
# [1,] "pres"     "3"      "5013.71314958759"
# [2,] "jd"       "1"      "5125.18336743162"
# [3,] "daynight" "2"      "5129.40985223595"
...
#      Included        Idx Vars AIC               
# [1,] "jd,pres"       "1 3"    "5009.27253191657"
# [2,] "daynight,pres" "2 3"    "5013.7135293072" 
...
#           Included           Idx Vars                AIC 
# "jd,daynight,pres"            "1 2 3" "5009.27418517481" 
...
# (Intercept)  1.27276    0.01782   71.43   <2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Approximate significance of smooth terms:
#               edf Ref.df      F p-value    
# s(dfMod$jd) 2.189      8  1.053 0.00874 ** 
# s(presBins) 2.517      9 14.261 < 2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# R-sq.(adj) =  0.0827   Deviance explained = 9.77%
# -REML = 2508.1  Scale est. = 0.38752   n = 1205
...
# Approximate significance of smooth terms:
#               edf Ref.df      F p-value
# s(dfMod$jd) 2.189  8.000  1.053 0.00874
# s(presBins) 2.517  9.000 14.261 < 2e-16

# make the plots
plot(bestModel, all.terms=TRUE, shade=TRUE)

```

Okay, from this it looks like we're seeing some interesting trends here. No day/night trend, and seasonality looks mainly flat. There is also broadly increasing group size as presence increases, which seems to be the trend mainly driving this.