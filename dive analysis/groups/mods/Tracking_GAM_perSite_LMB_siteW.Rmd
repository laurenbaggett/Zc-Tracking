...
# read in data
w = read.csv("F:/Tracking/groups/siteWmod/SOCAL_W_binned_20min_groups.csv")
...
# [1,] "daynight"      "1 3"    "3468.99725379098"
# [2,] "None excluded" "1 2 3"  "3470.54411692415"
# [3,] "jd"            "2 3"    "3470.98210223339"
# [4,] "pres"          "1 2"    "3524.71758019244"
...
#      Removed         Idx Vars AIC               
# [1,] "jd,daynight"   "3"      "3469.01297823565"
# [2,] "pres,daynight" "1"      "3523.42721615571"
...
# [1,] "pres"     "3"      "3469.01297823565"
# [2,] "jd"       "1"      "3523.42721615571"
# [3,] "daynight" "2"      "3536.3663252673" 
...
#      Included        Idx Vars AIC               
# [1,] "jd,pres"       "1 3"    "3468.99725379098"
# [2,] "daynight,pres" "2 3"    "3470.98210223339"
...
fwdSelection3[order(fwdSelection3[,3],decreasing=FALSE),]
          # Included           Idx Vars                AIC 
# "jd,daynight,pres"            "1 2 3" "3470.54411692415"
...
# (Intercept)  1.18866    0.02038   58.33   <2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Approximate significance of smooth terms:
#               edf Ref.df     F p-value    
# s(dfMod$jd) 2.311      8 1.244 0.00445 ** 
# s(presBins) 1.135      9 6.603 < 2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# R-sq.(adj) =  0.0654   Deviance explained = 7.64%
# -REML = 1736.4  Scale est. = 0.36858   n = 877
...
# Approximate significance of smooth terms:
#               edf Ref.df     F p-value
# s(dfMod$jd) 2.311  8.000 1.244 0.00445
# s(presBins) 1.135  9.000 6.603 < 2e-16
