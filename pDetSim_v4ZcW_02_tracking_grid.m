...
TLfile1 = 'F:\Tracking\prop\SOCAL_W_02\SOCAL_W_02_WE_Cuviers_40kH_3DTL.mat';
TLfile2 =  'F:\Tracking\prop\SOCAL_W_02\SOCAL_W_02_WS_Cuviers_40kH_3DTL.mat';
disp(['TLFile: ',TLfile1,' ', TLfile2])
load('F:\Tracking\prop\SOCAL_W_02\SOCAL_W_02_4ch_offset2_m.mat');
...
% modified these
a2.rd_all= cat(length(a2.rd_all),a2.rd_all{1:end-1});
a2.sortedTLVec= cat(length(a2.sortedTLVec),a2.sortedTLVec{1:end-1,:});
...
save('F:\Zc_Analysis\tracking_figures\track_density\SOCAL_W_02_detectionProbability.mat','allsim','alldet','allprob','xline','yline')
...
title('SOCAL H 74 Detection Probability')
